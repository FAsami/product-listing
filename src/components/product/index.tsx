  ...
  return (
    <div className="relative group">
      ...
      <div className="group-hover:bg-[#ebe6e6] bg-[#f5f5f5] rounded-lg relative overflow-hidden">
        ...
        <button className="absolute z-10 top-2.5 right-2.5 opacity-0 group-hover:opacity-100 transition-all duration-300">
          <HeartIcon />
        </button>
        <div className="absolute bottom-3 z-10 left-1/2 -translate-x-1/2 w-full flex flex-col items-center gap-2 opacity-0 group-hover:opacity-100 transition-all duration-300 px-3">
          <button className="border-white bg-[#FFFFFF4D] backdrop-blur-[8px] py-[5px] border-[1.5px] rounded-md flex items-center justify-center w-full gap-1">
            <ShoppingCartIcon />
